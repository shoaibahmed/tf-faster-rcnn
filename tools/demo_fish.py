...
NET = './output/res152_dense/train/default/res152_dense_faster_rcnn_iter_10000.ckpt'
BASE_DIR = './Datasets/ComplexBackground/'
DATASET = 'fish'
...
if __name__ == '__main__':
    ...
    outputFile = open(os.path.join(BASE_DIR, 'faster-rcnn/output-dense-2500.txt'), 'w')
